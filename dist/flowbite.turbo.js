...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.initAccordionByElement = exports.initAccordions = void 0;
...
function initAccordions($rootElement) {
...
function initAccordionByElement($accordionEl) {
...
exports.initAccordionByElement = initAccordionByElement;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.initCarouselByElement = exports.initCarousels = void 0;
var instances_1 = __webpack_require__(423);
var Default = {
    defaultPosition: 0,
    indicators: {
...
function initCarouselByElement($carouselEl) {
...
exports.initCarouselByElement = initCarouselByElement;
if (typeof window !== 'undefined') {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.initCopyClipboardByElement = exports.initCopyClipboards = void 0;
var instances_1 = __webpack_require__(423);
var Default = {
    htmlEntities: false,
    contentType: 'input',
...
function initCopyClipboards($rootElement) {
    if ($rootElement === void 0) { $rootElement = document; }
    $rootElement
...
function initCopyClipboardByElement($triggerEl) {
...
exports.initCopyClipboardByElement = initCopyClipboardByElement;
if (typeof window !== 'undefined') {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.initCollapseByElement = exports.initCollapses = void 0;
var instances_1 = __webpack_require__(423);
var Default = {
    onCollapse: function () { },
    onExpand: function () { },
...
function initCollapses($rootElement) {
    if ($rootElement === void 0) { $rootElement = document; }
    $rootElement
...
function initCollapseByElement($triggerEl) {
...
exports.initCollapseByElement = initCollapseByElement;
if (typeof window !== 'undefined') {
...
function initDatepickerByElement($datepickerEl) {
    if ($datepickerEl) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.initDialByElement = exports.initDials = void 0;
var instances_1 = __webpack_require__(423);
var Default = {
    triggerType: 'hover',
    onShow: function () { },
...
function initDials($rootElement) {
    if ($rootElement === void 0) { $rootElement = document; }
    $rootElement
...
function initDialByElement($parentEl) {
...
exports.initDialByElement = initDialByElement;
if (typeof window !== 'undefined') {
    window.Dial = Dial;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.initDismissByElement = exports.initDismisses = void 0;
var instances_1 = __webpack_require__(423);
var Default = {
...
function initDismisses($rootElement) {
    if ($rootElement === void 0) { $rootElement = document; }
    $rootElement
...
function initDismissByElement($triggerEl) {
...
exports.initDismissByElement = initDismissByElement;
if (typeof window !== 'undefined') {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.initDrawerShowByElement = exports.initDrawerHideByElement = exports.initDrawerToggleByElement = exports.initDrawerByElement = exports.initDrawers = void 0;
var instances_1 = __webpack_require__(423);
var Default = {
    placement: 'left',
    bodyScrolling: false,
...
function initDrawers($rootElement) {
    if ($rootElement === void 0) { $rootElement = document; }
    $rootElement
...
function initDrawerByElement($triggerEl) {
    // mandatory
...
exports.initDrawerByElement = initDrawerByElement;
function initDrawerToggleByElement($triggerEl) {
...
exports.initDrawerToggleByElement = initDrawerToggleByElement;
function initDrawerHideByElement($triggerEl) {
...
exports.initDrawerHideByElement = initDrawerHideByElement;
function initDrawerShowByElement($triggerEl) {
...
exports.initDrawerShowByElement = initDrawerShowByElement;
if (typeof window !== 'undefined') {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.initDropdownByElement = exports.initDropdowns = void 0;
...
function initDropdownByElement($triggerEl) {
...
exports.initDropdownByElement = initDropdownByElement;
if (typeof window !== 'undefined') {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.initInputCounterByElement = exports.initInputCounters = void 0;
var instances_1 = __webpack_require__(423);
var Default = {
    minValue: null,
    maxValue: null,
...
function initInputCounters($rootElement) {
    if ($rootElement === void 0) { $rootElement = document; }
    $rootElement
...
function initInputCounterByElement($targetEl) {
...
exports.initInputCounterByElement = initInputCounterByElement;
if (typeof window !== 'undefined') {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.initModalHideTriggerByElement = exports.initModalShowTriggerByElement = exports.initModalToggleTriggerByElement = exports.initModalByElement = exports.initModals = void 0;
var instances_1 = __webpack_require__(423);
var Default = {
    placement: 'center',
...
function initModals($rootElement) {
    if ($rootElement === void 0) { $rootElement = document; }
...
function initModalByElement($triggerEl) {
...
exports.initModalByElement = initModalByElement;
function initModalToggleTriggerByElement($triggerEl) {
...
exports.initModalToggleTriggerByElement = initModalToggleTriggerByElement;
function initModalShowTriggerByElement($triggerEl) {
...
exports.initModalShowTriggerByElement = initModalShowTriggerByElement;
function initModalHideTriggerByElement($triggerEl) {
...
exports.initModalHideTriggerByElement = initModalHideTriggerByElement;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.initPopoverByElement = exports.initPopovers = void 0;
/* eslint-disable @typescript-eslint/no-empty-function */
var core_1 = __webpack_require__(853);
var instances_1 = __webpack_require__(423);
var Default = {
...
function initPopovers($rootElement) {
    if ($rootElement === void 0) { $rootElement = document; }
    $rootElement
...
function initPopoverByElement($triggerEl) {
...
exports.initPopoverByElement = initPopoverByElement;
if (typeof window !== 'undefined') {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.initTabByElement = exports.initTabs = void 0;
var instances_1 = __webpack_require__(423);
var Default = {
    defaultTabId: null,
...
function initTabByElement($parentEl) {
    var tabItems = [];
...
exports.initTabByElement = initTabByElement;
if (typeof window !== 'undefined') {
    window.Tabs = Tabs;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.initTooltipByElement = exports.initTooltips = void 0;
/* eslint-disable @typescript-eslint/no-empty-function */
var core_1 = __webpack_require__(853);
var instances_1 = __webpack_require__(423);
var Default = {
...
function initTooltips($rootElement) {
    if ($rootElement === void 0) { $rootElement = document; }
    $rootElement
...
function initTooltipByElement($triggerEl) {
...
exports.initTooltipByElement = initTooltipByElement;
if (typeof window !== 'undefined') {
...
var turboLoadEvents = new events_1.default('turbo:load', [function () { return (0, index_1.initFlowbite)(); }]);
turboLoadEvents.init();
var turboFrameLoadEvents = new events_1.default('turbo:frame-load', [function () { return (0, index_1.initFlowbite)(); }]);
turboFrameLoadEvents.init();
var turboStreamLoadEvents = new events_1.default('turbo:after-stream-render', [
    function () { return (0, index_1.initFlowbite)(); },
]);
