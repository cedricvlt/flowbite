...
var turboLoadEvents = new Events('turbo:load', [function () { return initFlowbite(); }]);
turboLoadEvents.init();
var turboFrameLoadEvents = new Events('turbo:frame-load', [function () { return initFlowbite(); }]);
turboFrameLoadEvents.init();
var turboStreamLoadEvents = new Events('turbo:after-stream-render', [
    function () { return initFlowbite(); },
]);
