...
export declare function initDrawers($rootElement?: RootElement): void;
export declare function initDrawerByElement($triggerEl: Element): void;
export declare function initDrawerToggleByElement($triggerEl: Element): void;
export declare function initDrawerHideByElement($triggerEl: Element): void;
export declare function initDrawerShowByElement($triggerEl: Element): void;
