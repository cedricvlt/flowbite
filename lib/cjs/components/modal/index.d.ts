...
export declare function initModals($rootElement?: RootElement): void;
export declare function initModalByElement($triggerEl: Element): void;
export declare function initModalToggleTriggerByElement($triggerEl: Element): void;
export declare function initModalShowTriggerByElement($triggerEl: Element): void;
export declare function initModalHideTriggerByElement($triggerEl: Element): void;
